...
Server::Server(std::string &serverString): _host(""), _listen(0), 
	_clientMaxBodySize(0), _serverName(""), _socketFd(0){
...
void Server::print() const {
  ...
  for (std::map<std::string, std::string>::const_iterator i = _errorPage.begin();
           i != _errorPage.end(); ++i)
