...
enum requestType { GET, POST, DELETE, UNKNOWN };
...
private:
  ...
  // These variables are not meant to be parsed during the parsing of the
  // Request, this is handled during response generation.
